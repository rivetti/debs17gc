...
public class ByteArraySerializer extends
		RichFlatMapFunction<Tuple5<Integer, Integer, Integer, Integer, Double>, Tuple5<Integer, Integer, Integer, Integer, Double>> {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(ByteArraySerializer.class);
	...
	@Override
	// MID, TS, SID, VALUE
	public void flatMap(Tuple5<Integer, Integer, Integer, Integer, Double> value,
	...
	public class TerminationData {
		...
		public TerminationData(int machine) {
			super();
			this.sensorNum = ByteArraySerializer.this.machineSensorNum;
	...
	public class TimeStampData {
		...
		public TimeStampData(Tuple5<Integer, Integer, Integer, Integer, Double> value) {
			...
			this.count = ByteArraySerializer.this.machineSensorNum;
